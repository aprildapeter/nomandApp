                    ...
                    <div class="col-lg-4 ">
                        <div class="card card-details card-right">
                            ...
                            <div class="member my-2">
                                <img src="{{ url('frontend/images/avatar-1@2x.png') }}" class="member-ava mr-1">
                                <img src="{{ url('frontend/images/avatar-2.png') }}" class="member-ava mr-1">
                                <img src="{{ url('frontend/images/avatar-3.png') }}" class="member-ava mr-1">
                            </div>
                            <hr>
